...
"""
 ...
 def cadastrar_produto(nome, quantidade, preco, categoria, estoque):
   ...
   if quantidade < 0 or preco < 0:
     print("Erro: A quantidade ou o preço não podem ser negativos.")
    return
 ...
 def estoque_baixo(estoque, limite):
     ...
     for nome, dados in estoque.items():
         ...
         if quantidade <= limite:
             poucos_produtos.append((nome, quantidade, categoria))
     if not poucos_produtos:
         print("Nenhum produto com estoque baixo.")
     else:
         print(f"Produtos com estoque baixo (limite: {int(limite)} unidades):")
         print(f"{'PRODUTO':<15} {'QUANTIDADE':>8}")
         for nome, quantidade, categoria in poucos_produtos:
             print(f"{nome:<15} | {categoria:<15} | {int(quantidade):>4}")
...
from estoque import cadastrar_produto, consultar_estoque, estoque_baixo, preco_total, registrar_entrada, registrar_saida, ler_numero
estoque = {}
